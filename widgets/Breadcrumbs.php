...
class Breadcrumbs extends Widget
{
   ...
   */
  public $itemTemplate = "<li class=\"breadcrumb-item text-white text-sm\">{link}</li>\n";
  /**
   * @var string the template used to render each active item in the breadcrumbs. The token `{link}`
   * will be replaced with the actual HTML link for each active item.
   */
  public $activeItemTemplate = "<li class=\"breadcrumb-item text-white active\" aria-current=\"page\">{link}</li>\n";
  /**
  ...
  public function init()
  {
    ...
    Html::addCssClass($this->options, ['widget' => 'breadcrumb', 'class' => 'breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5']);
  }
